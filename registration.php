...
if (isset($_POST['regi_submit'])) {
    ...
    function validate(array $post_data)
    {
        ...
        if ($post_data['regi_name'] === "") {
            $_SESSION['validation_errors']['regi_name'] = true;
        }

        if ($post_data['regi_kana'] === "") {
            $_SESSION['validation_errors']['regi_kana'] = true;
        }

        if ($post_data['regi_branch'] === "") {
            $_SESSION['validation_errors']['regi_branch'] = true;
        }

        if ($post_data['regi_mail'] === "") {
            $_SESSION['validation_errors']['regi_mail'] = true;
        }
        ...
        if ($post_data['regi_pass'] === "") {
            $_SESSION['validation_errors']['regi_pass'] = true;
        }

        if ($post_data['regi_blood'] === NULL) {
            $_SESSION['validation_errors']['regi_blood'] = true;
        }
    }
