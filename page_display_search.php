...
<?php if ($page >= 2): ?>
    ...
    & search_sex=<?php echo $search_sex; ?>" class="page_feed">&laquo;</a>
...
<?php for ($i = 1; $i <= $max_page; $i++) : ?>
    <?php if ($i >= $page - $range && $i <= $page + $range) : ?>
        ...
        & search_sex=<?php echo $search_sex; ?>" class="page_number"><?php echo $i; ?></a>
...
<?php if ($page < $max_page) : ?>
    <a href="?page=<?php echo($page + 1); ?>& search_name=<?php echo $name; ?>
    & search_sex=<?php echo $search_sex; ?>" class="page_feed">&raquo;</a>
